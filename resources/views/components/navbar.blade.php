<div>
    ...
    <nav class="bg-[#ff8225]" x-data="{ isOpen: false }">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img class="size-40" src="{{ asset('images/logo.svg') }}" alt="GripPoint Logo">
                        </div>
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                            <a href="/dashboard" class="{{ request()-> is('dashboard') ? 'bg-[#173B45] text-white' : 'text-black  hover:text-white' }} rounded-md  px-3 py-2 text-sm font-medium" aria-current="page">Dashboard</a>
                            <a href="/products" class="{{ request() -> is('products') ? 'bg-[#173B45] text-white' : 'text-black  hover:text-white'}} rounded-md px-3 py-2 text-sm font-medium">Products</a>
                            <a href="/transaction" class="{{ request() -> is('transaction') ? 'bg-[#173B45] text-white' : 'text-black  hover:text-white'}} rounded-md px-3 py-2 text-sm font-medium">Transaction</a>
                            <a href="/user" class=" {{ request() -> is('user') ? 'bg-[#173B45] text-white' : 'text-black  hover:text-white'}} rounded-md px-3 py-2 text-sm font-medium">User</a>
                            </div>
                        </div>
                    </div>
